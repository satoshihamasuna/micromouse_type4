...
#define MOTOR_K_ER		(0.062)					//mV/rpm
#define MOTOR_K_TR		0.594	//0.4//0.594				//mNm/A
#define MOTOR_R			(5.5)//6.0
#define GEAR_N			(40/9)
#define MOUSE_INERTIA	0.001f//0.001f//0.003,0.0022				//g・m^2
#define RAD_2_RPM		60/(2*3.141592)
#define TIRE_RADIUS_M	(TIRE_RADIUS/1000)		//m
#define TREAD_WIDTH_M	((18.0-2.0)*2/1000)
#define MOTOR_BR		(0.0/100000)			//mNm/rpm
#define L_BAR_DT		(20/1000)

#define SIDE_THRESHOLD	(65.0)
#define FRONT_THRESHOLD	(118)

#define OFF_SET_LENGTH 10.0//10.0
